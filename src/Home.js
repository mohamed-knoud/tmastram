    ...
    <div>
        <div id="wrapper">
            {actual && <img id="poster" src={`https://image.tmdb.org/t/p/original${actual.backdrop_path}`} alt=""/>}<div>
                ...
                {actual && <span style={{fontSize:'1.3em',fontWeight:'900'}}>{actual.original_title.length>21?actual.original_title.substring(0,15)+"...":actual.original_title}</span>}
                <div style={{position:'relative',marginTop:'10px'}}>
                <span style={{display:'inline-block',transform: 'rotate(-90deg)'}}>Movie</span>
                 <Tooltip text="Watch Online">
                <span style={{fontSize:'0.8em',backgroundColor:'#ffd700',color:'#000',padding:'10px',marginRight:'5px',borderRadius:'5px',cursor:'pointer'}}>Watch <i style={{fontSize:'0.8em',color:'#000'}} className="fa-solid fa-play"></i></span>
                </Tooltip>
                <Tooltip text="Know more">
                <Link style={{textDecoration:'none'}} to={`detail/`}><span style={{fontSize:'0.8em',backgroundColor:'#ffd700',color:'#000',padding:'10px',marginRight:'5px',borderRadius:'5px',cursor:'pointer'}}>Detail</span></Link>
                </Tooltip>
