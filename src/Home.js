    ...
    <div>
        <div id="wrapper">
            {actual && <img id="poster" src={`https://image.tmdb.org/t/p/original${actual.backdrop_path}`} alt=""/>}<div>
                ...
                {actual && <span style={{fontSize:'1.5em',fontWeight:'900'}}>{actual.original_title.length>21?actual.original_title.substring(0,15)+"...":actual.original_title}</span>}
                ...
                <i style={{fontSize:'0.7em',margin:'0 10px',cursor:'pointer'}} className="fa-solid fa-plus"></i>

                </Tooltip>
                <Tooltip text="Share">
                <i style={{fontSize:'0.7em',margin:'0 10px',cursor:'pointer'}} className="fa-solid fa-share"></i>
