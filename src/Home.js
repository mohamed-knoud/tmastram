    ...
    <div>
        <div id="wrapper">
            {actual && <img id="poster" src={`https://image.tmdb.org/t/p/original${actual.backdrop_path}`} alt=""/>}<div>
                ...
                <div style={{position:'relative',bottom:'100px',border:'10px solid #1b191a',zIndex:'999',borderRadius:'60px',backgroundColor:'#000',color:'#a4b2c8',textAlign:'center',height:'auto',paddingBottom:'15px',width:'70%',fontSize:'0.4em'}}>
